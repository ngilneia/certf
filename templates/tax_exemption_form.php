<?php
$certificateType = 'Tax Exemption';
$requiredDocuments = [
    'voter_id' => 'Voter ID (Xerox copy)',
    'lc_vc_cert' => 'LC/VC Certification (Original)',
    'tribal_cert' => 'Tribal Certificate (Xerox Copy)'
];
...
<head>
    ...
    <title>Tax Exemption Certificate Application - Government Certificate Management System</title>
...
<body class="bg-gray-50">
    <div class="min-h-screen py-8">
        <div class="max-w-4xl mx-auto px-4">
            <h1 class="text-3xl font-bold text-gray-900 mb-8">Apply for Tax Exemption Certificate</h1>
            ...
            <form id="certificateForm" class="bg-white shadow-md rounded-lg p-6 space-y-6" method="POST" action="/api/applications/submit" enctype="multipart/form-data">
                ...
                <!-- Tax Exemption Specific Fields -->
                <div class="space-y-4">
                    <h2 class="text-xl font-semibold text-gray-800">Tax Exemption Details</h2>
                    <div class="grid grid-cols-1 md:grid-cols-2 gap-4">
                        <div>
                        ...
                        <div>
                            <label for="exemptionReason" class="block text-sm font-medium text-gray-700">Reason for Exemption</label>
                            <select id="exemptionReason" name="exemptionReason" required
                                class="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-indigo-500 focus:ring-indigo-500">
